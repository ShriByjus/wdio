...
const draftOrderMockData = require('../../../data/bepOrders/catOrders/streamingOrder/draftOrder.json');
const salesOrderMockData = require('../../../data/bepOrders/catOrders/streamingOrder/salesOrder.json');
const salesSubOrderMockData = require('../../../data/bepOrders/catOrders/streamingOrder/salesSubOrder.json');
...
describe('Validating BEP Gate Streaming order', async () => {
    ...
    it('Verify the Addon Items Skus', async () => {
        ...
        let addOnItemsSkusCsv = await verifyOmsOrderDetails.copyingAddOnItemsSkusFromCsv(4, process.env.ADD_ONN_ITEMS_SKUS_CSV);
    ...
    it('Verify the Shipemnt skus', async () => {
        ...
        let shipmentSkusCsv = await verifyOmsOrderDetails.copyingShipmentSkusFromCsv(1, process.env.SHIPMENT_SKUS_BEP_CSV);
    ...
    it('Verify the sales skus', async () => {
        ...
        allure.startStep("Copy shipment skus from Csv file");
        let salesSkusCsv = await verifyOmsOrderDetails.copyingSalesSkusFromCsv(1, process.env.SALES_SKUS_BEP_CSV);
