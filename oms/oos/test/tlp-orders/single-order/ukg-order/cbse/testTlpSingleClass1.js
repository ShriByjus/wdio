...
const draftOrderMockData = require('../../../../../data/btlpData/singleOrders/grade1/cbse/draftOrderLkg.json');
const salesOrderMockData = require('../../../../../data/btlpData/singleOrders/grade1/cbse/salesOrderLkg.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/singleOrders/grade1/cbse/salesSubOrderLkg.json');
...
describe('Validating grade 1 Single order', async () => {
