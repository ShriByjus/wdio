...
const draftOrderMockData = require('../../../../../data/btlpData/singleOrders/grade9/cbse/draftOrderClass9.json');
const salesOrderMockData = require('../../../../../data/btlpData/singleOrders/grade9/cbse/salesOrderClass9.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/singleOrders/grade9/cbse/salesSubOrderClass9.json');
...
describe('Validating grade 9 Single order', async () => {
