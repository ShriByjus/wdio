...
const draftOrderMockData = require('../../../../data/byjus-classes/combo-order/cbse/4th-grade-Order/draftOrder.json');
const salesOrderMockData = require('../../../../data/byjus-classes/combo-order/cbse/4th-grade-Order/salesOrder.json');
const salesSubOrderMockData = require('../../../../data/byjus-classes/combo-order/cbse/4th-grade-Order/salesSubOrder.json');
...
describe('Validating Byjus classes single order for 4th standard', async () => {
    ...
    it('Verify the Shipemnt skus', async () => {
        ...
        let shipmentSkusCsv = await verifyOmsOrderDetails.copyingShipmentSkusFromCsv(1, process.env.SHIPMENT_SKUS_BYJUS_CLASSES_CSV);
    ...
    it('Verify the sales skus', async () => {
        ...
        allure.startStep("Copy shipment skus from Csv file");
        let salesSkusCsv = await verifyOmsOrderDetails.copyingSalesSkusFromCsv(1, process.env.SALES_SKUS_BYJUS_CLASSES_CSV);
