...
const draftOrderMockData = require('../../data/akash-byjus-course/akash-byjus-live-program/8th-standard/draftOrder.json');
const salesOrderMockData = require('../../data/akash-byjus-course/akash-byjus-live-program/8th-standard/salesOrder.json');
const salesSubOrderMockData = require('../../data/akash-byjus-course/akash-byjus-live-program/8th-standard/salesSubOrder.json');
...
describe('Validating Aakash Byjus Courses single order for 8th standard', async () => {
    ...
    it('Verify the shipment skus and skus name', async () => {
        let shipmentSkuTablet = btlpOrderData.shipmentSkuAakashByjusCourses[0]
        let shipmentSkuSdCard = btlpOrderData.shipmentSkuAakashByjusCourses[1]
        let shipmentSkuTabletName = btlpOrderData.shipmentSkuNamesForAakashByjusCourses[0]
        let shipmentSkuSdCardName = btlpOrderData.shipmentSkuNamesForAakashByjusCourses[1]
    ...
    it('Verify the sales skus and skus names', async () => {
        let salesSkuSdCard = btlpOrderData.salesSkuForAakashByjusCourses[1]
        let salesSkuTablet = btlpOrderData.salesSkuForAakashByjusCourses[0]
        let salesSkuSdCardName = btlpOrderData.salesSkuNamesForAakashByjusCourses[1]
        let salesSkuTabletName = btlpOrderData.salesSkuNamesForAakashByjusCourses[0]
