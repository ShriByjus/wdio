...
const draftOrderMockData = require('../../data/akash-byjus-course/akash-byjus-live-program/12th-standard/draftOrder.json');
const salesOrderMockData = require('../../data/akash-byjus-course/akash-byjus-live-program/12th-standard/salesOrder.json');
const salesSubOrderMockData = require('../../data/akash-byjus-course/akash-byjus-live-program/12th-standard/salesSubOrder.json');
...
describe('Validating Aakash Byjus Courses single order for 12th standard', async () => {
    ...
    it('Verify the shipment skus and skus name', async () => {
        let shipmentSkuTablet = btlpOrderData.shipmentSkuAakashByjusCourses[4]
        let shipmentSkuSdCard = btlpOrderData.shipmentSkuAakashByjusCourses[5]
        let shipmentSkuTabletName = btlpOrderData.shipmentSkuNamesForAakashByjusCourses[4]
        let shipmentSkuSdCardName = btlpOrderData.shipmentSkuNamesForAakashByjusCourses[5]
    ...
    it('Verify the sales skus and skus names', async () => {
        let salesSkuSdCard = btlpOrderData.salesSkuForAakashByjusCourses[5]
        let salesSkuTablet = btlpOrderData.salesSkuForAakashByjusCourses[4]
        let salesSkuSdCardName = btlpOrderData.salesSkuNamesForAakashByjusCourses[5]
        let salesSkuTabletName = btlpOrderData.salesSkuNamesForAakashByjusCourses[4]
