...
const draftOrderMockData = require('../../../../../data/btlpData/singleOrders/ukgOrder/cbse/draftOrderUkg.json');
const salesOrderMockData = require('../../../../../data/btlpData/singleOrders/ukgOrder/cbse/salesOrderUkg.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/singleOrders/ukgOrder/cbse/salesSubOrderUkg.json');
...
describe('Validating UKG Single order', async () => {
