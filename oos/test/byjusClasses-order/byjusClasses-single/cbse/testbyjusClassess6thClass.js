...
const draftOrderMockData = require('../../../../data/byjus-classes/single-order/cbse/6th-grade-Order/drafrOrder.json');
const salesOrderMockData = require('../../../../data/byjus-classes/single-order/cbse/6th-grade-Order/salesOrder.json');
const salesSubOrderMockData = require('../../../../data/byjus-classes/single-order/cbse/6th-grade-Order/salesSubOrder.json');
...
describe('Validating Byjus classes single order for 6th standard', async () => {
    ...
    it('Verify the shipment skus and skus name', async () => {
        let shipmentSkuTablet = btlpOrderData.shipmentSkuIdForByjusClasses[0]
        let shipmentSkuSdCard = btlpOrderData.shipmentSkuIdForByjusClasses[1]
        let shipmentSkuTabletName = btlpOrderData.shipmentSkuNamesForByjusClasses[0]
        let shipmentSkuSdCardName = btlpOrderData.shipmentSkuNamesForByjusClasses[1]
    ...
    it('Verify the sales skus and skus names', async () => {
        let salesSkuSdCard = btlpOrderData.salesSkuForByjusClasses[0]
        let salesSkuTablet = btlpOrderData.salesSkuForByjusClasses[1]
        let salesSkuSdCardName = btlpOrderData.salesSkuNamesForByjusClasses[0]
        let salesSkuTabletName = btlpOrderData.salesSkuNamesForByjusClasses[1]
        let sdCardSku = await mongoconnect.getsalesSdCradSkuFromDB(salesOrderId);
        let tabletSku = await mongoconnect.getsalesTabletSkuFromDB(salesOrderId);
        ...
        let salesTabletSkuName = await mongoconnect.getsalesTabletSkuNameFromDB(salesOrderId);
