...
const draftOrderMockData = require('../../data/akash-byjus-course/akash-byjus-live-program/9th-standard/draftOrder.json');
const salesOrderMockData = require('../../data/akash-byjus-course/akash-byjus-live-program/9th-standard/salesOrder.json');
const salesSubOrderMockData = require('../../data/akash-byjus-course/akash-byjus-live-program/9th-standard/salesSubOrder.json');
...
describe('Validating Akash byjus course 8th-9th standard order', async () => {
    ...
    it('Verify the Addon Items Skus', async () => {
        ...
        let addOnItemsSkusCsv = await verifyOmsOrderDetails.copyingAddOnItemsSkusFromCsv(0, process.env.ADD_ONN_ITEMS_SKUS_CSV);
    ...
    it('Verify the Shipemnt skus', async () => {
        ...
        let shipmentSkusCsv = await verifyOmsOrderDetails.copyingShipmentSkusFromCsv(0, process.env.SHIPMENT_SKUS_AKASH_BYJUS_CSV);
    ...
    it('Verify the sales skus', async () => {
        ...
        allure.startStep("Copy shipment skus from Csv file");
        let salesSkusCsv = await verifyOmsOrderDetails.copyingSalesSkusFromCsv(0, process.env.SALES_SKUS_AKASH_BYJUS_CSV);
