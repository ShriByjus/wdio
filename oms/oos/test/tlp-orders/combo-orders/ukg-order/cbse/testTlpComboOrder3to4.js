...
const draftOrderMockData = require('../../../../../data/btlpData/comboOrders/comboOrderGrade3to4/cbse/draftOrderComboGrade3to4.json');
const salesOrderMockData = require('../../../../../data/btlpData/comboOrders/comboOrderGrade3to4/cbse/salesOrderComboGrade3to4.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/comboOrders/comboOrderGrade3to4/cbse/salesSubOrderComboGrade3to4.json');
...
describe('Validating Combo Order Grade 3 to 4', async () => {
    ...
    it('Verify the shipment skus and skus name', async () => {
        ...
        let shipmentSkuSdCard = btlpOrderData.shipmentSkuIdForBtlpOrders[17]
        let shipmentSkuTabletName = btlpOrderData.shipmentSkuNamesForBtlpOrders[14]
        let shipmentSkuSdCardName = btlpOrderData.shipmentSkuNamesForBtlpOrders[17]
    ...
    it('Verify the sales skus and skus names', async () => {
        let salesSkuSdCard = btlpOrderData.salesSkuIdForBtlpOrders[18];
        let salesSkuSdCardOne = btlpOrderData.salesSkuIdForBtlpOrders[19];
        console.log("sales value of Sd card" + salesSkuSdCard);
        let salesSkuTablet = btlpOrderData.salesSkuIdForBtlpOrders[15]
        let salesSkuSdCardName = btlpOrderData.salesSkuNamesForBtlpOrders[22];
        let salesSkuSdCardNameOne = btlpOrderData.salesSkuNamesForBtlpOrders[23];
