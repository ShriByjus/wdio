...
const draftOrderMockData = require('../../../data/bepOrders/gateOrders/streamingOrder/draftOrder.json');
const salesOrderMockData = require('../../../data/bepOrders/gateOrders/streamingOrder/salesOrder.json');
const salesSubOrderMockData = require('../../../data/bepOrders/gateOrders/streamingOrder/salesSubOrder.json');
...
describe('Validating BEP Gate Streaming order', async () => {


    beforeEach('logging in to Oms website', async () => {
    ...
    it('Verify the Addon Items Skus', async () => {
        ...
        let addOnItemsSkusCsv = await verifyOmsOrderDetails.copyingAddOnItemsSkusFromCsv(3, process.env.ADD_ONN_ITEMS_SKUS_CSV);
    ...
    it('Verify the Shipemnt skus', async () => {
        ...
        let shipmentSkusCsv = await verifyOmsOrderDetails.copyingShipmentSkusFromCsv(0, process.env.SHIPMENT_SKUS_BEP_CSV);
    ...
    it('Verify the sales skus', async () => {
        ...
        allure.startStep("Copy shipment skus from Csv file");
        let salesSkusCsv = await verifyOmsOrderDetails.copyingSalesSkusFromCsv(0, process.env.SALES_SKUS_BEP_CSV);
