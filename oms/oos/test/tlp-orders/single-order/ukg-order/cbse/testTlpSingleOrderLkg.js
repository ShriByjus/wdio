...
const draftOrderMockData = require('../../../../../data/btlpData/singleOrders/lkgOrder/cbse/draftOrderLkg.json');
const salesOrderMockData = require('../../../../../data/btlpData/singleOrders/lkgOrder/cbse/salesOrderLkg.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/singleOrders/lkgOrder/cbse/salesSubOrderLkg.json');
...
describe('Validating LKG Single order', async () => {
