...
const draftOrderMockData = require('../../../../../data/btlpData/comboOrders/lkgOrders/cbse/draftOrder.json');
const salesOrderMockData = require('../../../../../data/btlpData/comboOrders/lkgOrders/cbse/salesOrder.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/comboOrders/lkgOrders/cbse/salesSubOrder.json');
...
describe('Validating grade 4 Single order', async () => {
    ...
    it('Verify the shipment skus and skus name', async () => {
        let shipmentSkuTablet = btlpOrderData.shipmentSkuIdLkgCombo[0]
        let shipmentSkuSdCard = btlpOrderData.shipmentSkuIdLkgCombo[1]
        let shipmentSkuTabletName = btlpOrderData.shipmentSkuNamesLkgCombo[0]
        let shipmentSkuSdCardName = btlpOrderData.shipmentSkuNamesLkgCombo[1]
    ...
    it('Verify the sales skus and skus names', async () => {
        let salesSkuSdCard = btlpOrderData.salesSkuIdLkgCombo[0]
        let salesSkuSdCardOne = btlpOrderData.salesSkuIdLkgCombo[1]
        let salesSkuTablet = btlpOrderData.salesSkuIdLkgCombo[3]
        let salesSkuSdCardName = btlpOrderData.salesSkuNamesLkgCombo[0]
        let salesSkuSdCardNameOne = btlpOrderData.salesSkuNamesLkgCombo[1]
        let salesSkuTabletName = btlpOrderData.salesSkuNamesLkgCombo[3]
        ...
        let tabletSku = await mongoconnect.getsalesTabletSkuOneFromDB(salesOrderId);
        ...
        let salesTabletSkuName = await mongoconnect.getsalesTabletSkuNameOneFromDB(salesOrderId);
