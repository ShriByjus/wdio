...
const draftOrderMockData = require('../../../../../data/btlpData/comboOrders/comboOrderGrade1/cbse/draftOrder.json');
const salesOrderMockData = require('../../../../../data/btlpData/comboOrders/comboOrderGrade1/cbse/salesOrder.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/comboOrders/comboOrderGrade1/cbse/salesSubOrder.json');
...
describe('Validating Combo Order Grade 1 to 2', async () => {
    ...
    it('Verify the shipment skus and skus name', async () => {
        ...
        let shipmentSkuSdCard = btlpOrderData.shipmentSkuIdForBtlpOrders[15]
        let shipmentSkuTabletName = btlpOrderData.shipmentSkuNamesForBtlpOrders[14]
        let shipmentSkuSdCardName = btlpOrderData.shipmentSkuNamesForBtlpOrders[15]
    ...
    it('Verify the sales skus and skus names', async () => {
        let salesSkuSdCard = btlpOrderData.salesSkuIdForBtlpOrders[13];
        let salesSkuSdCardOne = btlpOrderData.salesSkuIdForBtlpOrders[14];
        console.log("sales value of Sd card" + salesSkuSdCard);
        let salesSkuTablet = btlpOrderData.salesSkuIdForBtlpOrders[15]
        let salesSkuSdCardName = btlpOrderData.salesSkuNamesForBtlpOrders[17];
        let salesSkuSdCardNameOne = btlpOrderData.salesSkuNamesForBtlpOrders[18];
