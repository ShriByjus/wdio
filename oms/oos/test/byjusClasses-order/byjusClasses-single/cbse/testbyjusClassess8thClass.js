...
const draftOrderMockData = require('../../../../data/byjus-classes/single-order/cbse/8th-grade-Order/drafrOrder.json');
const salesOrderMockData = require('../../../../data/byjus-classes/single-order/cbse/8th-grade-Order/salesOrder.json');
const salesSubOrderMockData = require('../../../../data/byjus-classes/single-order/cbse/8th-grade-Order/salesSubOrder.json');
...
describe('Validating Byjus classes single order for 8th standard', async () => {
    ...
    it('Verify the shipment skus and skus name', async () => {
        let shipmentSkuTablet = btlpOrderData.shipmentSkuIdForByjusClasses[2]
        let shipmentSkuSdCard = btlpOrderData.shipmentSkuIdForByjusClasses[3]
        let shipmentSkuTabletName = btlpOrderData.shipmentSkuNamesForByjusClasses[2]
        let shipmentSkuSdCardName = btlpOrderData.shipmentSkuNamesForByjusClasses[3]
    ...
    it('Verify the sales skus and skus names', async () => {
        let salesSkuSdCard = btlpOrderData.salesSkuForByjusClasses[2]
        let salesSkuTablet = btlpOrderData.salesSkuForByjusClasses[3]
        let salesSkuSdCardName = btlpOrderData.salesSkuNamesForByjusClasses[2]
        let salesSkuTabletName = btlpOrderData.salesSkuNamesForByjusClasses[3]
