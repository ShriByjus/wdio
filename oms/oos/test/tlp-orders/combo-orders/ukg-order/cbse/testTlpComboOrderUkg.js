...
const draftOrderMockData = require('../../../../../data/btlpData/comboOrders/ukgOrders/cbse/draftOrder.json');
const salesOrderMockData = require('../../../../../data/btlpData/comboOrders/ukgOrders/cbse/salesOrder.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/comboOrders/ukgOrders/cbse/salesSubOrder.json');
...
describe('Validating UKG Combo order', async () => {
    ...
    it('Verify the Shipemnt skus', async () => {
        ...
        let shipmentSkusCsv = await verifyOmsOrderDetails.copyingShipmentSkusFromCsv(1, process.env.SHIPMENT_SKUS_BTLP_CSV);
