...
const draftOrderMockData = require('../../../../../data/btlpData/streamingOrders/ukgOrders/cbse/draftOrder.json');
const salesOrderMockData = require('../../../../../data/btlpData/streamingOrders/ukgOrders/cbse/salesOrder.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/streamingOrders/ukgOrders/cbse/salesSubOrder.json');
...
describe('Validating 4th class Streaming order', async () => {
    ...
    it('Verify the sales skus', async () => {
        ...
        let salesSkusCsv = await verifyOmsOrderDetails.copyingSalesSkusFromCsv(4, process.env.SALES_SKUS_BTLP_CSV);
