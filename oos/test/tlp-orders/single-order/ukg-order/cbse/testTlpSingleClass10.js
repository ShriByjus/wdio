...
const draftOrderMockData = require('../../../../../data/btlpData/singleOrders/grade10/cbse/draftOrderClass10.json');
const salesOrderMockData = require('../../../../../data/btlpData/singleOrders/grade10/cbse/salesOrderClass10.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/singleOrders/grade10/cbse/salesSubOrderClass10.json');
...
describe('Validating grade 10 Single order', async () => {
