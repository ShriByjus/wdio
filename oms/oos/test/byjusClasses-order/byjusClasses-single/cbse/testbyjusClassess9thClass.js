...
const draftOrderMockData = require('../../../../data/byjus-classes/single-order/cbse/9th-grade-Order/drafrOrder.json');
const salesOrderMockData = require('../../../../data/byjus-classes/single-order/cbse/9th-grade-Order/salesOrder.json');
const salesSubOrderMockData = require('../../../../data/byjus-classes/single-order/cbse/9th-grade-Order/salesSubOrder.json');
...
describe('Validating Byjus classes single order for 9th standard', async () => {
    ...
    it('Verify the shipment skus and skus name', async () => {
        let shipmentSkuTablet = btlpOrderData.shipmentSkuIdForByjusClasses[4]
        let shipmentSkuSdCard = btlpOrderData.shipmentSkuIdForByjusClasses[5]
        let shipmentSkuTabletName = btlpOrderData.shipmentSkuNamesForByjusClasses[4]
        let shipmentSkuSdCardName = btlpOrderData.shipmentSkuNamesForByjusClasses[5]
    ...
    it('Verify the sales skus and skus names', async () => {
        let salesSkuSdCard = btlpOrderData.salesSkuForByjusClasses[4]
        let salesSkuTablet = btlpOrderData.salesSkuForByjusClasses[5]
        let salesSkuSdCardName = btlpOrderData.salesSkuNamesForByjusClasses[4]
        let salesSkuTabletName = btlpOrderData.salesSkuNamesForByjusClasses[5]
