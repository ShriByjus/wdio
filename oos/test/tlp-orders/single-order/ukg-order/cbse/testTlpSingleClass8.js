...
const draftOrderMockData = require('../../../../../data/btlpData/singleOrders/grade8/cbse/draftOrderClass8.json');
const salesOrderMockData = require('../../../../../data/btlpData/singleOrders/grade8/cbse/salesOrderClass8.json');
const salesSubOrderMockData = require('../../../../../data/btlpData/singleOrders/grade8/cbse/salesSubOrderClass8.json');
...
describe('Validating grade 8 Single order', async () => {
