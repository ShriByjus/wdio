...
const draftOrderMockData = require('../../../../data/btlpData/singleOrders/lkgOrder/icse/draftOrderLkg.json');
const salesOrderMockData = require('../../../../data/btlpData/singleOrders/lkgOrder/icse/salesOrderLkg.json');
const salesSubOrderMockData = require('../../../../data/btlpData/singleOrders/lkgOrder/icse/salesSubOrderLkg.json');
...
describe('Validating grade 2 Single order', async () => {
    ...
    it('Verify the shipment skus and skus name', async () => {
        let shipmentSkuTablet = btlpOrderData.shipmentSkuIdForBtlpOrders[7]
        let shipmentSkuSdCard = btlpOrderData.shipmentSkuIdForBtlpOrders[8]
        let shipmentSkuTabletName = btlpOrderData.shipmentSkuNamesForBtlpOrders[2]
        let shipmentSkuSdCardName = btlpOrderData.shipmentSkuNamesForBtlpOrders[3]
    ...
    it('Verify the sales skus and skus names', async () => {
        let salesSkuSdCard = btlpOrderData.salesSkuIdForBtlpOrders[7]
        let salesSkuTablet = btlpOrderData.salesSkuIdForBtlpOrders[8]
        let salesSkuSdCardName = btlpOrderData.salesSkuNamesForBtlpOrders[5]
        let salesSkuTabletName = btlpOrderData.salesSkuNamesForBtlpOrders[6]
